...
for(ML in 1:length(model_names)){
  ...
  print(paste("Executing Dirichlet Regression for algorithm: " ,model_names[ML],"....... Out of Sample" ,sep = "" ))
  
  
  load("All_Forecasts_OOS.RData") 
  Predictions_Ensemble <- All_Predictions[[ML]] ## Number decides model chosen
