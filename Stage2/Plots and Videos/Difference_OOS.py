...
def plot_week(sg_regions_gdf, case_data_df, week_of_year, year, img_number, vmin, vmax, dataset_number):
    ...
    image_path = folder_path + f'\\out_{dataset_number}_map_week_{img_number}.png'
...
for dataset_number in range(1, 13):
    case_data_path = folder_path + f'\\W_{dataset_number}_Deviation_OutofSample.csv'
    ...
    output_video_path = folder_path + f'\\fix_out_{dataset_number}.mp4'
