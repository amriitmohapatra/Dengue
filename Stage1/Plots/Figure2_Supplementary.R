...
png(file = 'WeightsDistv2_A1.png',height=70,width=100,units='cm',res=300,pointsize=10)
pushViewport(plotViewport(c(7,1,1,1)))
pushViewport(viewport(layout=grid.layout(nrow=2,ncol=2)))

letter_counter = 1
for(week_num in c(1,2,3,4)){
  ...
  if(week_num == 1 || week_num == 5 || week_num == 9){
    row_counter <- 1
    col_counter <- 1
  } else if(week_num == 2 || week_num == 6 || week_num == 10){
    row_counter <- 1
    col_counter <- 2
  } else if(week_num == 3 || week_num == 7 || week_num == 11){
    row_counter <- 2
    col_counter <- 1
  } else if(week_num == 4 || week_num == 8 || week_num == 12){
    row_counter <- 2
    col_counter <- 2
  }
...
png(file = 'WeightsDistv2_A2.png',height=70,width=100,units='cm',res=300,pointsize=10)
pushViewport(plotViewport(c(7,1,1,1)))
pushViewport(viewport(layout=grid.layout(nrow=2,ncol=2)))

for(week_num in c(5,6,7,8)){
...
png(file = 'WeightsDistv2_A3.png',height=70,width=100,units='cm',res=300,pointsize=10)
pushViewport(plotViewport(c(7,1,1,1)))
pushViewport(viewport(layout=grid.layout(nrow=2,ncol=2)))

for(week_num in c(9,10,11,12)){
